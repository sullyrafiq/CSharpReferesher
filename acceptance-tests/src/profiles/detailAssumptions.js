...
module.exports = Object.assign({}, standardProfile, {
  yourCar: Object.assign({}, standardProfile.yourCar, {
    detailsAssumption: false,
    securityDeviceId: 6, // Thatcham Approved Cat 1
    imported: true,
    importTypeId: 2, // Yes - Euro UK spec
    numberOfSeats: 1
  }),
  aggResponse: {
    activityTypeId: 1,
    ...
    visitorId: 'JCWzGVCFKLs2OlmvOK4X',
    sourceCode: 'TIV',
    visitorIPAddress: '127.0.0.1',
    sessionId: '443f687f-d1c9-4d5b-9da9-5e557bda4b28',
    brandFilter: null,
    payload: {
      policy: {
