...
const additionalDrivers = [
  Object.assign(additionalDriver, {
    employmentStatus: -1, // Not in paid work
    additionalDriverUnemployedType: 842 // Househusband
  })
];
...
const profile = Object.assign({}, standardProfile, {
  yourDetails: Object.assign({}, standardProfile.yourDetails, {
    employmentStatus: -1, // Not in paid work
    unemployedType: 842 // Househusband
  }),
  ...
  aggResponse: {
    ...
    payload: {
      ...
      policyHolder: {
        ...
        mainOccupation: {
          occupationId: 842,
          employmentStatusId: 5,
          businessSectorId: 520
        },
