...
['registrationNumber', 'selectedVehicle', 'vehicle', 'numberOfSeats']
  .forEach(question => delete yourCar[question]);

module.exports = Object.assign({}, standardProfile, {
  yourCar: Object.assign({}, {
    isManualVehicle: true,
    makeId: 20, // Audi
    modelId: 163, // A3
    engineTypeId: 1, // Petrol
    transmissionId: 1, // Manual
    manufacturedYear: 1996,
    engineLitres: '1.6',
    variantId: 871, // Sport
    manualVehicle: 'AUDI A3 1996 - 2003 Petrol 1.6L Manual 3 Doors Hatchback',
