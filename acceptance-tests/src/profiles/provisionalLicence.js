...
const yourDetails = Object.assign({}, standardProfile.yourDetails);

['licenceIssueCountry', 'licenceCover', 'licenceWithAdditionalQualification']
  .forEach(question => delete yourDetails[question]);

module.exports = Object.assign({}, standardProfile, {
  yourDetails: Object.assign({}, yourDetails, {
    licenceType: 'Provisional (UK only)',
    hasLicenceNumber: true,
    licenceNumber: ['JONES', '912129', 'AA1', 'AA']
  }),
  aggResponse: {
    activityTypeId: 1,
    channelId: null,
    ...
    visitorId: 'DJYni8SIc0zE7c73S1Jx',
    sourceCode: 'TIV',
    visitorIPAddress: '127.0.0.1',
    sessionId: '3ca538f8-c29e-4daa-aabd-c6187c7d4ac2',
    brandFilter: null,
    payload: {
      policy: {
      ...
      policyHolder: {
        ...
        licenceTypeId: 13,
        licenceNumber: 'JONES912129AA1AA',
        maritalStatusId: 2,
        relationshipId: null,
