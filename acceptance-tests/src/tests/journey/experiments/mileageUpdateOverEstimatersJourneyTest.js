...
const personalMilesPerYear = 9000;
...
module.exports = {
  ...
  'Then I should not see the mileage update notification box': (client) => {
    client.page.resultsPage().waitForElementNotPresent('@mileageUpdate');
  },
  ...
  'Then I should see the mileage update notification box': (client) => {
    client.page.resultsPage()
      ...
      .waitForElementPresent('@mileageUpdate');
  },

  'When I click on use new mileage button': (client) => {
    client.page.resultsPage().click('@confirmMileageUpdate');
  },
  ...
  'Then I should not see the mileage update notification box any longer': (client) => {
    client.page.resultsPage().waitForElementNotPresent('@mileageUpdate');
    client.end();
  }
};
