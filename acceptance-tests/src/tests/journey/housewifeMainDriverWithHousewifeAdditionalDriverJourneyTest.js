import profile from '../../profiles/housewifeMainDriverWithHousewifeAdditionalDriver';
import JourneyRunner from '../../common/journeyRunner';

module.exports = {
  'tags': ['journey', 'forward-journey', 'housewife-main-driver-with-housewife-additional-driver-journey'],
